...
const $$Edit = createComponent(async ($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "PrivateLayout", $$PrivateLayout, { "title": "Edit Policy" }, { "default": async ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="space-y-6"> <div class="flex flex-wrap justify-between items-center gap-4"> <h1 class="text-3xl font-bold text-white tracking-tight">
Edit Privacy Policy
...
Loading policy...
</div> <form id="policy-form" class="space-y-6 hidden"> <input type="hidden" name="projectId"> <div class="space-y-2"> <div class="text-sm font-mono text-gray-300">Project</div> <div id="project-title" class="w-full bg-gray-900/40 border border-gray-800 rounded-lg px-4 py-3 text-white font-semibold"></div> </div> <div class="space-y-4"> <div class="flex flex-wrap gap-2" role="tablist"> <button type="button" id="policy-tab-privacy" role="tab" aria-selected="true" aria-controls="policy-panel-privacy" data-tab="privacy" class="px-4 py-2 text-sm font-mono rounded-lg border transition-colors text-white border-cyan-500/60 bg-cyan-500/10">
Privacy Policy
...
UPDATE POLICY
</button> </form> </div> ` })} ${renderScript($$result, "/Users/hafiz/Developments/portfolio-astro/src/pages/admin/policies/edit.astro?astro&type=script&index=0&lang.ts")}`;
}, "/Users/hafiz/Developments/portfolio-astro/src/pages/admin/policies/edit.astro", void 0);

const $$file = "/Users/hafiz/Developments/portfolio-astro/src/pages/admin/policies/edit.astro";
const $$url = "/admin/policies/edit";
