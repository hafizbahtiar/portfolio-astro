...
import { b as getPublicFamilyTreesByGlobalKey, a as getPublicFamilyTreeBySlug, g as getPublicFamilyTrees } from './family_C_CDot2R.mjs';
...
const FamilyTreeChart = ({
  ...
  if (chartData.length === 0) {
    return /* @__PURE__ */ jsx("div", { className: "rounded-xl border border-gray-800 bg-gray-900/40 p-5 text-sm text-gray-400", children: "No people available to render chart." });
  }
  return /* @__PURE__ */ jsx("div", { className: "rounded-xl border border-gray-800 bg-gray-900/40 p-3 text-cyan-200", children: /* @__PURE__ */ jsx("div", { ref: containerRef, className: "f3 h-[720px] w-full overflow-hidden" }) });
};

export { FamilyTreeChart as F };
