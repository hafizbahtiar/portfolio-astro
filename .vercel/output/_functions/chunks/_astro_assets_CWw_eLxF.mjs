...
const assetQueryParams = undefined;
					const imageConfig = {"endpoint":{"route":"/_image"},"service":{"entrypoint":"astro/assets/services/noop","config":{}},"dangerouslyProcessSVG":false,"domains":["www.qiubbx.com","qiubbx.com","cit.securiforce.net","eperolehan.dbkl.gov.my","github.com","avatars.githubusercontent.com","media.licdn.com"],"remotePatterns":[],"responsiveStyles":false};
