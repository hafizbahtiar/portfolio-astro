...
export const CombinedFamilyExplorer = () => {
  ...
  if (isLoading) {
    return <div className="h-full w-full min-h-[320px] rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 flex items-center justify-center p-6 text-slate-500 dark:text-slate-400">Loading combined family data...</div>;
  }
  if (error) {
    return <div className="h-full w-full min-h-[320px] rounded-xl border border-red-500/40 bg-red-500/10 flex items-center justify-center p-6 text-red-300">{error}</div>;
  }
  if (!detail || !hasPeople) {
    return <div className="h-full w-full min-h-[320px] rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 flex items-center justify-center p-6 text-slate-500 dark:text-slate-400">Combined family data unavailable.</div>;
  }
